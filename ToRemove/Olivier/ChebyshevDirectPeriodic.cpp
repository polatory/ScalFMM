...
class TestChebyshevDirect : public FUTester<TestChebyshevDirect> {
	...
	void RunTest()	{
		...
		//FmaRWParticle<4,8>* const particles = new FmaRWParticle<4,8>[nbParticles];
		//
...
//			particles[idxPart].setPosition(position) ;
//			particles[idxPart].setPhysicalValue( value);
//			particles[idxPart].setPotential(0.0);
//			particles[idxPart].setForces(0.0,0.0,0.0);
		...
		for(int idxTarget = 0 ; idxTarget < loader.getNumberOfParticles() ; ++idxTarget){
			...
			//			particles1[idxTarget].setPosition(particles[idxTarget].position);
			//			particles1[idxTarget].setPhysicalValue(particles[idxTarget].physicalValue);
			//			particles1[idxTarget].setPotential(particles[idxTarget].potential);
			//			particles1[idxTarget].setForces(particles[idxTarget].forces[0],particles[idxTarget].forces[1],
			//						particles[idxTarget].forces[2]);
