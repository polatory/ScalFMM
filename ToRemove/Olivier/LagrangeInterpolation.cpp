// ===================================================================================
// Copyright ScalFmm 2011 INRIA, P. Blanchard, Berenger Bramas, Olivier Coulaud
...
/**
 * This program runs the FMM Algorithm with the Lagrange kernel and compares the results with a direct computation.
 */
/// \file  ChebyshevInterpolationAlgorithm.cpp
//!
//! \brief This program runs the FMM Algorithm with the interpolation kernel based on Lagrange interpolation (1/r kernel)
//!  \authors P. Blanchard, O. Coulaud
//!
//!  This code is a short example to use the Lagrange Interpolation approach for the 1/r kernel
//!
//!@Algorithm
