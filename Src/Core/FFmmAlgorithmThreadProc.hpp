...
#pragma omp single nowait 
			{
				...
				for(int idxLevel = 2 ; idxLevel < OctreeHeight ; ++idxLevel ){
					...
					// Which cell potentially needs other data and in the same time
					// are potentially needed by other
					MortonIndex neighborsIndexes[189];
					for(int idxCell = 0 ; idxCell < numberOfCells ; ++idxCell){
						// Find the M2L neighbors of a cell
						...
						// Test each neighbors to know which one do not belong to us
